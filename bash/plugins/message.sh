...
function abcli_message() {
    ...
    if [ "$task" == "help" ] ; then
        abcli_help_line "$abcli_name message listen_to host_1" \
            "listen to host_1 messages."
        abcli_help_line "$abcli_name message listen_as host_1" \
            "listen to messages as host_1."
        abcli_help_line "$abcli_name message submit [--data data] [--filename filename_1] [--recipient host_1,host_2] [--subject subject_1]" \
            "submit message [w/ subject_1] [+data] [+filename_1] [to host_1, host_2]."
        abcli_help_line "$abcli_name message update [--recipient host_1,host_2]" \
