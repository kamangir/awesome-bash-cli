...
built by 🌀 [`blue_options-4.76.1-abcli-current`](https://github.com/kamangir/awesome-bash-cli), based on 🪄 [`abcli-9.331.1`](https://github.com/kamangir/awesome-bash-cli).
